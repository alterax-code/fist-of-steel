...
/**
 * Ennemi Mage - Utilise son set complet de sprites
 */
public class Mage extends Enemy {
    ...
    protected void loadTextures() {
        try {
            System.out.println("🗡️ Chargement complet des sprites Mage...");
            
            // ⭐ IDLE - 14 FRAMES !
            idleTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Mage/Idle/idle1.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle2.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle3.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle4.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle5.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle6.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle7.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle8.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle9.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle10.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle11.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle12.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle13.png"),
                new Texture("assets/sprites/sbires/Mage/Idle/idle14.png")
            };
            
            // ⭐ HURT - 4 FRAMES
            hurtTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Mage/Hurt/hurt1.png"),
                new Texture("assets/sprites/sbires/Mage/Hurt/hurt2.png"),
                new Texture("assets/sprites/sbires/Mage/Hurt/hurt3.png"),
                new Texture("assets/sprites/sbires/Mage/Hurt/hurt4.png")
            };
            
            // ⭐ WALK - 6 FRAMES
            walkTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Mage/Walk/walk1.png"),
                new Texture("assets/sprites/sbires/Mage/Walk/walk2.png"),
                new Texture("assets/sprites/sbires/Mage/Walk/walk3.png"),
                new Texture("assets/sprites/sbires/Mage/Walk/walk4.png"),
                new Texture("assets/sprites/sbires/Mage/Walk/walk5.png"),
                new Texture("assets/sprites/sbires/Mage/Walk/walk6.png")
            };
            
            // ⭐ ATTACK - 7 FRAMES (attack0 à attack4)
            attackTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Mage/Attack/attack0.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack1.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack2.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack3.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack4.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack5.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack6.png"),
                new Texture("assets/sprites/sbires/Mage/Attack/attack7.png")
            };
            
            // ⭐ DEATH - 10 FRAMES
            deadTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Mage/Death/death1.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death2.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death3.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death4.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death5.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death6.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death7.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death8.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death9.png"),
                new Texture("assets/sprites/sbires/Mage/Death/death10.png")
            };
            
            System.out.println("✅ Tous les sprites Mage chargés avec succès !");
            ...
            System.err.println("❌ ERREUR chargement sprites Mage: " + e.getMessage());
            e.printStackTrace();
    ...
    // ⭐ HITBOX DIRECTIONNELLE : Réduite de 25% du côté où le Mage regarde
    @Override
    protected boolean useDirectionalHitbox() {
        return true; // Mage utilise une hitbox directionnelle
    }

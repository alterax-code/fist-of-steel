...
/**
 * Ennemi Knight - Utilise son set complet de sprites
 */
public class Knight extends Enemy {
    ...
    protected void loadTextures() {
        try {
            System.out.println("🗡️ Chargement complet des sprites Knight...");
            
            // ⭐ IDLE - 12 FRAMES !
            idleTextures = new Texture[]{
                new Texture("assets/sprites/sbires/Knight/Idle/idle1.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle2.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle3.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle4.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle5.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle6.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle7.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle8.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle9.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle10.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle11.png"),
                new Texture("assets/sprites/sbires/Knight/Idle/idle12.png")
            };
            ...
            // ⭐ ATTACK - 5 FRAMES (attack0 à attack4)
            ...
            System.out.println("✅ Tous les sprites Knight chargés avec succès !");
            ...
            System.err.println("❌ ERREUR chargement sprites Knight: " + e.getMessage());
            e.printStackTrace();
    ...
    // ⭐ HITBOX DIRECTIONNELLE : Réduite de 25% du côté où le Knight regarde
    @Override
    protected boolean useDirectionalHitbox() {
        return true; // Knight utilise une hitbox directionnelle
    }
